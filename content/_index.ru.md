...
{{< callout type="info" >}}
  🧪 **Статус тестирования**: signal2sip был протестирован вживую на реальном оборудовании АТС, в нескольких конфигурациях и сценариях звонков - но ещё не прошёл широкого независимого тестирования. Нашли баг, или всё сработало хорошо? Обратная связь приветствуется - откройте [issue или PR](https://github.com/signal2sip/signal2sip) на GitHub, или просто напишите нам на почту.
{{< /callout >}}
